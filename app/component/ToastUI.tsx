...
const ToastUI: React.FC<ToastUIProps> = ({ title, body }) => {
  useEffect(() => {
    initTE({ Toast })
  }, [])
  return (
    <div
      className="pointer-events-auto mx-auto mb-4 hidden w-96 max-w-full rounded-lg bg-success-100 bg-clip-padding text-sm text-success-700 shadow-lg shadow-black/5 data-[te-toast-show]:block data-[te-toast-hide]:hidden absolute bottom-4 right-4"
      id="static-example"
      role="alert"
      aria-live="assertive"
      aria-atomic="true"
